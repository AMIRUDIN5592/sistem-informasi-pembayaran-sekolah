...
<div class="modal fade" id="createModal" tabindex="-1" role="dialog" aria-labelledby="createModalLabel" aria-hidden="true">
  <div class="modal-dialog" role="document">
    ...
    <div class="form-group">
        ...
        <select required name="tipe_tagihan" id="tipe_tagihan" class="form-control">
    ...
    <div class="form-group">
        ...
        <select required name="id_kelas" id="id_kelas" class="form-control"> <option disabled="" selected="">- PILIH KELAS -</option>
